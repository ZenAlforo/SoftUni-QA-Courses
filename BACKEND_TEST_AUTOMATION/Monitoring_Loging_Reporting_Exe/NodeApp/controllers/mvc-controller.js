...
const measureRequestTime = async (req, res, asyncHandler) => {
...
function setup(app, data) {
  // my endpoint for metrics
  app.get("/metrics", async (req, res) => {
    await measureRequestTime(req, res, async (req, res) => {
  ...
  app.get("/", async (req, res) => {
    await measureRequestTime(req, res, (req, res) => {
  ...
  app.get("/contacts/find/:keyword", async (req, res) => {
